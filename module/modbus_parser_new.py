...
class ModbusParser:
    ...
    def _get_handler(self, fc):
        ...
        return {
            ...
            3: wrapper(self._handle_read_registers, self._handle_read_registers_response),
            4: wrapper(self._handle_read_registers, self._handle_read_registers_response),
            ...
            15: wrapper(self._handle_write_multiple, self._handle_write_multiple_response),
            16: wrapper(self._handle_write_multiple, self._handle_write_multiple_response),
    ...
    def _handle_write_multiple(self, buffer, start, sid, fc):
        ...
        self._log_data(f"Master\t-> ID: {sid}, FC: 0x{fc:02x}, Write addr: {addr}, Quantity: {qty}")
        if fc == 16:
